...
def test_session_runtime_tracks_sub_questions_and_evidence_matrix() -> None:
    ...
    runtime.store_memory_hints("session-1", ["prior topic page", "naming convention"])
    runtime.store_episode_id("session-1", "episode-1")
    ...
    assert snapshot.memory_hints == ["prior topic page", "naming convention"]
