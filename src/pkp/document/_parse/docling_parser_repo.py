...
from pkp.utils._contracts import OcrVisionRepo, ParsedDocument, ParsedElement, ParsedSection
from pkp.document._parse._util import default_title_from_location, normalize_whitespace, slugify
from pkp.schema._types.content import DocumentType, SourceType
...
class DoclingParserRepo:
    ...
    def __init__(self, ocr_repo: OcrVisionRepo | None = None) -> None:
    ...
    def _build_converter() -> DocumentConverter:
        ...
        return DocumentConverter(
            allowed_formats=[InputFormat.PDF, InputFormat.MD, InputFormat.DOCX, InputFormat.IMAGE],
            format_options={
