...
from pkp.interfaces._eval.embedding_repo import LexicalEmbeddingRepo
from pkp.interfaces._eval.models import (
...
from pkp.utils._contracts import (
    EmbeddingProviderBinding,
    ModelProviderRepo,
    OcrVisionRepo,
)
from pkp.storage._search.sqlite_vector_repo import SQLiteVectorRepo
from pkp.interfaces._runtime.adapters import InstrumentedReranker
from pkp.interfaces._runtime.provider_metadata import embedding_space, provider_model, provider_name
...
from pkp.schema._types.content import Chunk, ChunkRole, SourceType
