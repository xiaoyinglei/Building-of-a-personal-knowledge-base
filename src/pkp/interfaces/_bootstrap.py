...
from pkp.utils._contracts import OcrResult, OcrVisionRepo, VectorRepo
...
from pkp.document._vision.ocr_vision_repo import DeterministicOcrVisionRepo, create_default_ocr_repo
from pkp.interfaces._runtime.adapters import (
...
from pkp.interfaces._runtime.diagnostics_runtime import DiagnosticsRuntime, ProviderBinding
...
from pkp.interfaces._runtime.provider_metadata import capability_configured, embedding_space
...
from pkp.query._retrieval.contracts import Reranker
