...
from rag.schema.runtime import GraphRepo
...
class GraphStore:
    ...
    def bind_node_evidence(self, node_id: str, chunk_ids: list[str] | tuple[str, ...]) -> None:
        self.graph_repo.bind_node_evidence(node_id, chunk_ids)
    ...
    def delete_node(self, node_id: str) -> None:
        self.graph_repo.delete_node(node_id)

    def delete_edge(self, edge_id: str, *, include_candidates: bool = True) -> None:
        self.graph_repo.delete_edge(edge_id, include_candidates=include_candidates)
...
__all__ = ["GraphStore", "Neo4jGraphRepo", "SQLiteGraphRepo"]
