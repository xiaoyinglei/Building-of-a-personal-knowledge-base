...
from rag.llm._rerank.models import RerankEvaluationCase, RerankEvaluationSummary, StageMetrics
...
class RerankEvaluator:
    def evaluate(
        ...
        *,
        ...
        by_stage = {stage: self._metrics_for_cases(cases, ranking_map) for stage, ranking_map in stage_rankings.items()}
